...
### Web Applications:
- [My Personal Portfolio](https://h-24-gn7z.onrender.com/) - A custom-built portfolio website developed using Python Flask to showcase my technical projects and professional journey. 
