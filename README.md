...
- [Build an Image Recognition App](https://enlight.nyc/projects/ml5-seefood)
- [Derive the Y Combinator](https://enlight.nyc/projects/y-combinator)
...
- [Build a Geolocation Weather App](https://enlight.nyc/projects/weather)
- [Build a Hex Color Generator](https://enlight.nyc/projects/hex-color-generator)
- [Build a Clock](https://enlight.nyc/projects/clock)
- [Build a Code Editor](https://enlight.nyc/projects/code-editor)
- [Build a Web Paint App](https://enlight.nyc/projects/web-paint)
- [Build a Chrome Extension to Clip Text](https://enlight.nyc/projects/build-a-chrome-extension-to-clip-text)
...
- [Build a To Do App in React](https://enlight.nyc/projects/react-to-do-list)
...
- [Get the Best Product Deals with a Web Scraper](https://enlight.nyc/projects/build-a-web-scraper)
...
- [Integrate your Google Calendar with Flask](https://enlight.nyc/projects/build-a-flask-web-app)
...
- [Build a Naive Bayes Classifier](https://enlight.nyc/projects/build-a-naive-bayes-classifier)
...
- [CreateML Image Classification](https://enlight.nyc/projects/create-ml)
- [Build an Image Segmentation App](https://enlight.nyc/projects/image-segmentation-mobile-app)
